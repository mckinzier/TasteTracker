...
let favoriteFoods = ["crab", "Sushi", "noodles", "ice cream", "pancakes", "steak"];
...
console.log("My #2 favorite food is " + favoriteFoods[0] + ".");
console.log("My #3 favorite food is " + favoriteFoods[3] + ".");
